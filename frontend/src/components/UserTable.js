  ...
  return (
    ...
    <table className="min-w-full border border-gray-200 bg-white shadow-md rounded-lg text-sm sm:text-base">
      <thead className="bg-teal-700 text-white">
        <tr>
          <th className="p-2 sm:p-3 text-left w-1/12 hidden md:table-cell">
            Id No.
          </th>
          <th className="p-2 sm:p-3 text-left w-3/12">Name</th>
          <th className="p-2 sm:p-3 text-left w-3/12">Role</th>
          <th className="p-2 sm:p-3 text-left w-3/12 hidden lg:table-cell">
            Permissions
          </th>
            ...
            <td className="p-2 sm:p-3 text-center">
              <button
                ...
                className={`px-2 py-1 sm:px-3 sm:py-1 text-xs sm:text-sm text-white rounded ${
                  user.status ? "bg-teal-400" : "bg-red-400"
                } hover:opacity-70`}
              >
